...
export const questions: QuestionInput[] = [
  {
    ...
    selectCount: 1,
    explanation:
      "A generic prompt produces a generic result; supplying the missing context (role, date, actual process) is what turns a vague request into an effective one. Assuming incapability (B, C) or repeating the identical prompt (D) doesn't address the actual cause.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "easy",
  },
  {
    id: "assoc-pte-002",
    ...
    selectCount: 1,
    explanation:
      "Naming the specific concern (liability caps) inside a broader topic (indemnification) focuses the output on what actually matters to the reader. Being merely accurate isn't the same as being useful (A); shortening (C) or reformatting (B) doesn't add the missing focus.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "A bug report is only as complete as the information supplied to generate it — the fix is supplying the missing specifics, not padding length (A), format (C), or abandoning the tool (D).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Repeat the word 'important' several times throughout the prompt for emphasis." },
      { id: "C", text: "State the desired format and length (e.g., a one-page brief with named sections)." },
      { id: "D", text: "Ask Claude to make the brief 'creative and impactful' without further detail." },
    ],
    correctOptionIds: ["A","C"],
    selectCount: 2,
    explanation:
      "Naming the audience/key message and the expected format are concrete constraints that shape a usable draft. A vague adjective like 'impactful' (D) or repeated emphasis words (B) don't give the model anything concrete to act on.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Tone is controllable through prompting when the desired style is actually described or demonstrated with an example — the gap here is a missing tone specification, not an inherent limitation (D), and a word count (B) or emphasis punctuation (A) wouldn't fix a tone mismatch.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "easy",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Specifying the audience and desired format turns a technically correct summary into a genuinely usable one for that audience. This is a prompting gap, not a capability limit (D) or a data problem (B), and manually rewriting each time (C) doesn't scale.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "hard",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Without the real requirements, Claude fills the gap with plausible-sounding assumptions — supplying the actual agreed-on details is the fix, not length (C), visuals (B), or accepting invented content as unavoidable (A).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Create effective prompts for business and technical tasks'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "A multi-part request with dependent steps benefits from sequential decomposition — each step's output can be checked before it feeds the next. Repeating the same all-at-once request (D) doesn't fix the structural problem, and dropping a needed part (C) or letting the model guess priority (A) doesn't address it either.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "medium",
  },
  {
    id: "assoc-pte-009",
    ...
    selectCount: 1,
    explanation:
      "Each stage here genuinely depends on the one before it (you can't meaningfully assess risk before knowing the inventory), so sequential decomposition with review between stages produces a more grounded plan than asking for everything at once (D) or working out of dependency order (A, B).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 2,
    explanation:
      "Sequencing by real dependency (venue before outreach that references venue details) and reviewing each stage before proceeding (D, A) is sound decomposition. The run-of-show does depend on venue layout/capacity (B is wrong), and bundling dependent steps into one request (C) forfeits the chance to catch errors early.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Bundling several substantial asks into one flat request tends to produce shallower treatment of each part than decomposing them; this isn't a refusal (B) or an ordering issue (C), and it's not risk-free (D).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "easy",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Reviewing each document individually before a separate cross-document comparison pass avoids diluting attention across many documents in one shot; combining everything into one pass (C) risks shallow treatment, and skipping documents (A) or working with no structure (B) both undermine a thorough review.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "hard",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Decomposing this task in dependency order — real findings before causes, causes before fixes — keeps the later steps grounded in fact rather than guesswork; starting from actions (A), a generic template (D), or skipping location-level detail (C) all skip the necessary foundation.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "A consistent per-module template plus a final consistency pass avoids the uneven depth that comes from a single flat request (D) covering 8 different modules at once, without skipping needed coverage (A) or leaving consistency to chance (B).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Apply task decomposition techniques to structure complex requests'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Targeted feedback on the specific issue (tone) preserves the parts that already worked (structure, content) while fixing what didn't — starting over (D) discards useful work, manual rewriting without feedback (C) doesn't improve future prompts, and accepting a tone mismatch (B) ignores a real brand-fit problem.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "easy",
  },
  {
    id: "assoc-pte-016",
    ...
    selectCount: 1,
    explanation:
      "Inconsistent results across similar requests are usually a sign of ambiguous instructions, not model malfunction (B) or a fundamental inability to control length (C, A) — replacing 'short' with a concrete constraint resolves the ambiguity.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Targeted iteration — fixing the one specific gap while keeping the usable 90% — is more efficient than discarding good work (A). Manually patching without feeding it back (D) fixes this one instance but not the process, and asking Claude to invent pricing (C) risks a fabricated number reaching a client.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 2,
    explanation:
      "Vagueness and length are the two named complaints — asking for concrete examples (D) and a specific length target (B) directly address them. Vocabulary sophistication (C) doesn't address either complaint, and starting over with an unrelated prompt (A) abandons the feedback entirely.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "A prompt or template that was correct once can go stale as the underlying facts change, so it needs to be revisited and iterated — leaving it untouched (A) or asking customers to compensate for known inaccuracies (B) isn't appropriate, and abandoning automation entirely (D) is an overcorrection.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Conflicting instructions across turns can be resolved inconsistently; the fix is clarifying priority or giving one clear consolidated instruction, not assuming perfect guessing (D), assuming conflicts are automatically ignored (C), or that a fresh conversation is the only option (B).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "hard",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Precise, targeted feedback on the one problem preserves the otherwise-solid structure; discarding the whole thing (C, A) wastes good work, and silently patching it without feeding back the correction (B) doesn't improve the next similar request.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Iterate prompts to improve output quality'",
    difficulty: "easy",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Brainstorming benefits from explicitly requesting breadth before narrowing — asking for 'the best' name up front (A, C) collapses the exploration too early, and lengthening one suggestion (D) doesn't produce more options.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "easy",
  },
  {
    id: "assoc-pte-023",
    ...
    selectCount: 1,
    explanation:
      "Research tasks need explicit scope boundaries to stay focused on the actual goal; without them, the output stays broad and unfocused. Assuming broader is always better (D), just shortening the format (A), or changing subjects entirely (B) don't add the missing focus.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Drafting tasks that need to match a specific voice benefit from concrete examples to imitate, which is more effective than a vague adjective repeated without detail (C); accepting generic output (B) or changing the task entirely (D) doesn't solve the actual problem.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "medium",
  },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "For a drafting task, give no tone or format guidance so the model has full creative freedom." },
      { id: "B", text: "For an analysis task, ask the model to show its reasoning and cite specific evidence." },
      { id: "C", text: "For a brainstorming task, ask for a wide range of ideas before narrowing to a favorite." },
      { id: "D", text: "For a research task, leave the scope completely open so nothing is missed." },
    ],
    correctOptionIds: ["B","C"],
    selectCount: 2,
    explanation:
      "Breadth-before-narrowing suits brainstorming (C), and requiring shown reasoning/evidence suits analysis (B). Leaving research scope completely open (D) tends to produce unfocused results, and withholding tone/format guidance for drafting (A) tends to produce generic output rather than useful creative freedom.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Research and drafting are different task types with a natural dependency here — the draft should be grounded in verified research, so research-then-draft in sequence, with a review step, produces a more reliable result than reversing the order (C), skipping research (D), or combining both into one undifferentiated request (A).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "medium",
  },
  {
    ...
    selectCount: 1,
    explanation:
      "Asking for premature narrowing within the same request as the brainstorm undercuts the point of brainstorming (generating breadth before judging) — this isn't refusal (B) or a guarantee of technical incorrectness (A), and it isn't risk-free (D).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 1 — 'Adapt prompting strategies based on task type'",
    difficulty: "medium",
  },
