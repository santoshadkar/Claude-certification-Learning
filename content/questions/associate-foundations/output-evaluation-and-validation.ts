...
export const questions: QuestionInput[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "An accurate statement can still be incomplete in a way that leads to a wrong conclusion if important context is missing." },
      { id: "C", text: "22% growth figures are always suspicious and should be assumed wrong." },
      { id: "D", text: "The report should be shortened further to reduce the chance of errors." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A true statement can still mislead if it omits context needed to interpret it correctly — this is the completeness half of evaluation, distinct from accuracy. Discarding the whole report (A), assuming the number itself is wrong (C), or just shortening further (D) all miss the actual issue.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Evaluate Claude-generated outputs for accuracy and completeness'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "Delete the decisions that don't have a clear owner." },
      { id: "D", text: "Ask Claude to rewrite the notes in a more formal tone instead." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "Accuracy about what was decided doesn't guarantee completeness about what's needed to act on it — missing ownership is a real gap worth fixing before circulation. Accepting as-is (A), deleting content (C), or a tone change (D) don't address the missing information.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Evaluate Claude-generated outputs for accuracy and completeness'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      { id: "A", text: "More historical data points." },
      { id: "B", text: "An explicit statement of the assumptions underlying the projection, which is necessary for the document to actually support a decision." },
      { id: "C", text: "A longer executive summary." },
      { id: "D", text: "Nothing was missing, since all historical figures were accurate." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A forecast is incomplete for decision-making purposes if its underlying assumptions aren't stated, even when every historical figure it cites is accurate. More historical data (A) or a longer summary (C) don't address the missing assumptions, and accuracy of citations (D) isn't the same as completeness for the document's purpose.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Evaluate Claude-generated outputs for accuracy and completeness'",
    difficulty: "hard",
  },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "The case exists but is simply hard to find with a basic search." },
      { id: "B", text: "This is a likely hallucination — a fabricated, specific-sounding case citation — and the memo's legal claims should not be used until this is resolved." },
      { id: "C", text: "Case names are always paraphrased by Claude, so this is expected and fine." },
      { id: "D", text: "The memo should be used as-is since the surrounding legal reasoning is probably still sound." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A specific, unverifiable citation is a classic hallucination pattern and must be resolved before the memo is relied on — assuming it's just hard to find (A), that fabricated names are normal and acceptable (C), or that the rest is fine regardless (D) all understate the risk.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Identify hallucinations, inconsistencies, and biases in responses'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Flag the inconsistency and reconcile the two figures against the actual source data before using either number." },
      { id: "C", text: "Average the two numbers together." },
      { id: "D", text: "Ignore the discrepancy since both numbers are in the same document." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "An internal inconsistency (the same fact stated differently in two places) should be reconciled against the actual source data, not resolved by guessing (A), averaging (C), or ignoring it (D) — all of which could leave a wrong number in circulation.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Identify hallucinations, inconsistencies, and biases in responses'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      { id: "A", text: "No concern — university prestige is a valid, objective measure of candidate quality." },
      ...
      { id: "C", text: "The issue is not correctable and resume screening should be abandoned entirely." },
      { id: "D", text: "Switching to a faster model will resolve the pattern." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A pattern that favors one group without a job-relevant justification is a bias concern worth investigating and correcting, not treating as an objective, valid signal (A). It's a fixable process issue, not a reason to abandon the tool (C), and model speed (D) is unrelated to bias in ranking criteria.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Identify hallucinations, inconsistencies, and biases in responses'",
    difficulty: "hard",
  },
  {
    ...
    options: [
      { id: "A", text: "Treat the quote as a likely fabrication and remove or verify it against the actual source data before the report is used." },
      { id: "B", text: "Search the actual source feedback data to confirm whether any comment closely matches this sentiment before keeping a similar claim in the report." },
      { id: "C", text: "Keep the quote as written, since it plausibly reflects the general sentiment even if not a real quote." },
      { id: "D", text: "Attribute the quote to a specific real customer at random so it appears sourced." },
    ],
    correctOptionIds: ["A", "B"],
    selectCount: 2,
    explanation:
      "An unverifiable direct quote should be treated as a likely fabrication (A) and checked against the real data (B) before it's used. Keeping a fabricated quote because it 'feels' representative (C) or inventing a false attribution (D) both introduce inaccurate content presented as fact.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Identify hallucinations, inconsistencies, and biases in responses'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Ask Claude to double-check its own number and trust the answer if it reaffirms 31%." },
      { id: "B", text: "Verify the 31% figure directly against the actual financial statements before it's sent to investors." },
      { id: "C", text: "Round the number to 30% to be safe." },
      { id: "D", text: "Send the update and correct it later if anyone questions the figure." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A financial figure going to investors must be verified against the authoritative source (actual financials) — asking the model to self-confirm (A) isn't real verification, rounding (C) doesn't address whether the number is right in the first place, and sending first and correcting later (D) is backwards for investor-facing material.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Apply fact-checking and validation techniques'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Publish it, since HR policy language is usually written this way." },
      { id: "B", text: "Check the actual labor code text to confirm Section 12.4 says what the document claims before publishing." },
      { id: "C", text: "Remove the section reference entirely and keep the rest of the claim unchanged." },
      { id: "D", text: "Ask Claude for a different section number instead." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A specific legal/regulatory citation should be checked against the actual source text before it's published as the basis for a policy — familiarity with the style of the language (A) isn't verification, and removing (C) or swapping (D) the citation without checking doesn't confirm whether the underlying claim is even correct.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Apply fact-checking and validation techniques'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Publish it, since Claude wrote it in a confident, professional tone." },
      { id: "B", text: "Confirm the credential directly with the speaker or their official bio before publishing, since an incorrect credential claim is easily checkable and embarrassing if wrong." },
      { id: "C", text: "Remove all mention of education to avoid the issue entirely." },
      { id: "D", text: "Assume it's correct since it's a minor detail." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A specific, checkable credential claim should be confirmed with an authoritative source (the speaker or their official bio) before publication — confident tone (A) isn't evidence, and removing the detail (C) or assuming it's fine because it seems minor (D) don't resolve whether the claim was accurate.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Apply fact-checking and validation techniques'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      { id: "A", text: "Locate and check the actual study being referenced, if one exists, to confirm the 40% figure and its context." },
      { id: "B", text: "If no specific study can be found or verified, soften or remove the specific statistic rather than publishing an unverified number." },
      { id: "C", text: "Publish the claim as-is, since it sounds scientifically plausible." },
      { id: "D", text: "Change the number to a rounder figure like 50% to make it sound more polished." },
    ],
    correctOptionIds: ["A", "B"],
    selectCount: 2,
    explanation:
      "Checking the actual source (A) and removing an unverifiable specific claim rather than publishing it anyway (B) are the correct validation steps. Plausibility isn't verification (C), and altering an unverified number cosmetically (D) doesn't make it accurate.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Apply fact-checking and validation techniques'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Distribute it immediately since it's just an internal newsletter." },
      ...
      { id: "C", text: "Remove all specifics and just say 'stretch regularly' to avoid any review." },
      { id: "D", text: "Ask Claude to add a disclaimer and skip any human review." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "Health-adjacent advice reaching many employees carries real accuracy and liability stakes and warrants review by someone qualified, even for 'just' an internal newsletter (A). Stripping content to avoid review (C) or substituting a disclaimer for actual review (D) don't address the underlying need for expert sign-off.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Determine when human review or additional verification is required'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "None — a quick read-through by the drafting associate is sufficient." },
      { id: "B", text: "Legal and communications review before release, given the public, high-stakes nature of a statement about a data incident." },
      { id: "C", text: "Only a grammar check, since the content itself is straightforward." },
      { id: "D", text: "No review is needed if the statement sounds sincere." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "A public statement addressing a data incident carries legal and reputational stakes that call for legal/communications review, not just a quick pass (A), a grammar check (C), or judging it by tone alone (D).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Determine when human review or additional verification is required'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "It requires the same legal and compliance review as an external press release." },
      { id: "C", text: "It should be escalated to executive leadership before being shared with the team." },
      { id: "D", text: "It should not be shared until a formal risk assessment is completed." },
    ],
    correctOptionIds: ["A"],
    selectCount: 1,
    explanation:
      "Recognizing when heavy review is *not* required is as much a part of this skill as knowing when it is — a routine, low-stakes internal summary just needs a normal accuracy check, not the escalation appropriate for high-stakes external content (B, C, D).",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Determine when human review or additional verification is required'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      { id: "A", text: "It includes legally significant terms (a release of claims) that carry real legal consequences for both parties." },
      { id: "B", text: "It involves a specific financial figure tied to an individual employee's termination, which HR/legal should confirm against policy and any negotiated terms." },
      { id: "C", text: "It was drafted quickly, which is reason enough on its own regardless of content." },
      { id: "D", text: "It's addressed to a single named individual rather than a general audience." },
    ],
    correctOptionIds: ["A", "B"],
    selectCount: 2,
    explanation:
      "The legally binding release-of-claims language (A) and the specific financial terms tied to an individual's termination (B) are exactly the kind of stakes that call for HR/legal review. Draft speed alone (C) isn't the relevant signal, and being addressed to one named person (D) isn't inherently high-risk by itself.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Determine when human review or additional verification is required'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Use the same technical release notes for both audiences to save time." },
      { id: "B", text: "Write the engineering notes with implementation detail, and a separate customer-facing version focused on what changed for the user, in plain language." },
      { id: "C", text: "Only publish the customer-facing version and skip internal notes entirely." },
      { id: "D", text: "Only write the internal engineering notes, since customers rarely read changelogs." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "The two audiences need different levels of technical detail and framing — engineers need implementation specifics, customers need plain-language impact. Using one version for both (A) serves neither well, and skipping either audience (C, D) leaves a real gap.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Edit, adapt, refine, and compare outputs for the intended audience'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      { id: "A", text: "Write one version with full statistical methodology and jargon, and use it unchanged for both audiences." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "For frontline staff, focus on clear step-by-step instructions for how to submit expenses under the new policy." },
      ...
      { id: "C", text: "Use the exact same document for both audiences to ensure the message is identical." },
      { id: "D", text: "For frontline staff, lead with the budget-impact analysis before any instructions." },
    ],
    correctOptionIds: ["A", "B"],
    selectCount: 2,
    explanation:
      "Frontline staff need actionable how-to guidance (A), while leadership needs rationale and impact framing (B) — these are genuinely different needs from the same underlying policy change. Using one identical document for both (C) serves neither well, and leading staff instructions with a budget analysis instead of the steps they actually need (D) misses their real need.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Edit, adapt, refine, and compare outputs for the intended audience'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "An artifact — a standalone document new hires can return to, that can be easily edited and updated as the process changes." },
      { id: "C", text: "A series of short, disconnected chat messages." },
      { id: "D", text: "A spoken summary with no written record." },
    ],
    correctOptionIds: ["B"],
    selectCount: 1,
    explanation:
      "Long-form, reusable reference content is exactly what an artifact is for — standalone, easy to revisit and edit. An inline-only response (A), fragmented messages (C), or no written record at all (D) all make repeated reference harder than it needs to be.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Organize and curate information and select appropriate output formats'",
    difficulty: "easy",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "A new artifact document created specifically for this one short answer." },
      { id: "C", text: "A structured JSON object." },
      { id: "D", text: "A formal slide deck." },
    ],
    correctOptionIds: ["A"],
    selectCount: 1,
    explanation:
      "A short conversational answer belongs inline — creating an artifact (B), structured data (C), or a slide deck (D) for a quick one-off question is unnecessary overhead that doesn't match the nature of the request.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Organize and curate information and select appropriate output formats'",
    difficulty: "medium",
  },
  {
    ...
    options: [
      { id: "A", text: "Structured JSON with clearly named fields matching what the script expects." },
      { id: "B", text: "A well-formed table with consistent columns that can be exported to CSV." },
      { id: "C", text: "A conversational paragraph describing the data in prose." },
      { id: "D", text: "A single run-on sentence listing all values separated by commas with no clear structure." },
    ],
    correctOptionIds: ["A", "B"],
    selectCount: 2,
    explanation:
      "Data meant for automated consumption needs a genuinely structured format — JSON with named fields (A) or a clean, exportable table (B) — rather than prose (C) or an unstructured run-on list (D), both of which are hard for a script to parse reliably.",
    citation:
      "Claude Certified Associate – Foundations Exam Guide §6, Domain 2 — 'Organize and curate information and select appropriate output formats'",
    difficulty: "medium",
  },
